...
```{r citybins,fig.cap="Sampling areas in Lusaka.",cache=TRUE,cap.align="center",cache=TRUE}
...
```{r leafborderareas,echo=FALSE,fig.cap="Sampling border areas in the four countries."}
leaflet() %>% 
  addTiles() %>% 
